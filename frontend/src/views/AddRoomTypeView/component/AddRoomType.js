      ...
      <Card className={classes.card}>
        ...
        <Formik
          ...
          validationSchema={Yup.object().shape({
            name: Yup.string().required("Roomtype name is required !"),
            ...
            images: Yup.array().required(
              "Image is required, up more 2 images !"
            ),
          })}
          onSubmit={(values) => {
            dispatch(
                  ...
                  <Card style={{ width: "50%" }}>
                    <CardContent>
                      ...
                      <div className={classes.fields}>
                        <TextField
                          error={
                            props.errors.capacity && props.touched.capacity
                              ? true
                              : false
                          }
                          helperText={
                      ...
                      >
                        {categories.map((category) => (
                          <FormControlLabel
                            ...
                            control={
                              <Checkbox
                                checked={props.values.extras.includes(
                                  category.id
                                )}
                                onChange={(e) => {
                                  if (e.target.checked)
                                    ...
                                    const idx = props.values.extras.indexOf(
                                      category.id
                                    );
                ...
                <CardContent>
                        ...
                        .then((snapshot) => {
                          snapshot.ref
                            ...
                            .then((url) => {
                              ...
                              props.setFieldValue(
                                "attachments",
                                props.values.attachments.concat(acceptedFiles)
                              );

                              return url;
                            })
                            .then((url) => {
                              if (props.values.thumbnail === "") {
                                props.setFieldValue("thumbnail", url);
                              } else {
                                props.setFieldValue(
                                  "images",
                  ...
                  >
                    {({
                      ...
                      return props.values.attachments.map((file, i) => (
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Button
                        ...
                        type="submit"
                        onClick={() => {
                          handleCancel(props.values.images);
                        }}
                        variant="contained"
                      >
...
const categories = [
  {
    id: "Plush pillows and breathable bed linens",
  ...
  {
    id: "Full-sized, pH-balanced toiletries",
    name: "Full-sized, pH-balanced toiletries",
  },
